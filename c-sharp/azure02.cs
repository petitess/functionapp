...
namespace WeatherStatus
{
    ...
    {
        [FunctionName("Function1")]//"0 7,12,15 * * *"
        public async Task Run([TimerTrigger("0 7,12,15 * * *")] TimerInfo myTimer, ILogger log)
        {
            ...
            //string urlAzure = "https://management.azure.com/subscriptions/2d9f44ea-e3df-4ea1-b956-8c7a43b119a0/resourceGroups/rg-owner-prod-01?api-version=2022-09-01";
            string urlAzure = "https://management.azure.com/subscriptions/2d9f44ea-e3df-4ea1-b956-8c7a43b119a0/providers/Microsoft.Resources/tags/default?api-version=2021-04-01";
            ...
            try
            {
                ...
                jsonAzure["properties"]["tags"]["TEMPERATURE"] = 55;
                jsonAzure["properties"]["tags"]["SYNC"] = timeStamp;
                jsonAzure["operation"] = "merge";
